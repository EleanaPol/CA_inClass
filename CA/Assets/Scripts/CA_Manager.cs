...
public class CA_Manager : MonoBehaviour
{
    ...
    public void CreateGrid()
    {
        ...
        states_updated = new bool[numCells];
    ...
    public void RunCA()
    {
        for (int i = 0; i < numCells; i++)
        {
            ...
            if (state == true)
            {
                ...
                {
                    states_updated[i] = true;
                }
                else
                {
                    states_updated[i] = false;
                }
            }
            // cell is dead
            else
        ...
        (states_current, states_updated) = (states_updated, states_current);
        UpdateAllCellColors();
    }
